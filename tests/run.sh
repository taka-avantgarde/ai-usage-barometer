...
# README language, the English-only UI explained, and no claim that Warming up
# is fabricated as 100%.
READMES=(
...
for readme in "${READMES[@]}"; do
  ...
  grep -q '\*\*⚙ Display settings\*\*' "$ROOT/$readme"
  grep -q '14' "$ROOT/$readme"
