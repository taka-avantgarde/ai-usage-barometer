...
ส่วนหัวบนแถบเมนูจะเรนเดอร์เป็น PDF เวกเตอร์ขนาดเล็กด้วยเครื่องมือที่มีอยู่ใน macOS เท่านั้น แทนข้อความ ANSI 24 บิต จึงรักษาสี HEX ของแต่ละช่วงได้อย่างแม่นยำโดยไม่ต้องติดตั้ง Xcode Command Line Tools
